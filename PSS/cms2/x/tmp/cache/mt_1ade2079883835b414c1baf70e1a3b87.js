...
tinymce.init({
    ...
    cmsms_tiny: cmsms_tiny = {
        ...
        filepicker_url: 'http://localhost/x/admin/moduleinterface.php?mact=FilePicker,m1_,filepicker,0&__c=87f8706a2d93e42d2ef&showtemplate=false&field=',
        filebrowser_title: 'Select a file',
        linker_text: 'Link to CMSMS Page',
        linker_title: 'Create a link to a CMSMS content page',
        linker_image: 'http://localhost/x/modules/MicroTiny/lib/images/cmsmslink.gif',
        linker_url: 'http://localhost/x/admin/moduleinterface.php?mact=MicroTiny,m1_,linker,0&__c=87f8706a2d93e42d2ef&showtemplate=false',
        linker_autocomplete_url: 'http://localhost/x/admin/moduleinterface.php?mact=MicroTiny,m1_,ajax_getpages,0&__c=87f8706a2d93e42d2ef&showtemplate=false',
        mailto_text: 'Create a mail link',
        mailto_title: 'Create a mail image',
        mailto_image: 'http://localhost/x/modules/MicroTiny/lib/images/mailto.gif',
